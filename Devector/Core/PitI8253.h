...
// TODO: test this realization:
// https://github.com/opicron/mame/blob/master/emu/machine/pit8253.h

// TODO: test the code below. It was generated by AI Claude
...
namespace dev
{
    ...
    private:
        struct Counter {
            ...
            uint8_t mode = 0;
            bool bcd = false;
            bool waiting_for_count = false;
            bool latched_count = false;
            uint8_t rw_mode = 0;
            bool output = true;
            bool gate = true;
    ...
    public:
        PitI8253(std::function<void(int, bool)> callback)
